...
import { RefreshControl, SafeAreaView, ScrollView, useColorScheme } from "react-native";
...
const betterData = [
  {
    ...
    date: "TUESDAY, NOVEMBER 08 2022 5:30 PM", // TODO: fix this date format
  },
  {
    sample:true,
    eventKey: "2",
    ...
    date: "THURSDAY, NOVEMBER 10 2022 9:30 PM", // TODO: fix this date format
  },
  {
    sample:true,
    eventKey: "3",
    ...
    date: "SATURDAY, NOVEMBER 12 2022 8:30 PM", // TODO: fix this date format
  },
];
...
export default function Activities() {
  ...
  const onRefresh = async () => {
    ...
    (async function getData() {
      ...
      setEvents((events.concat(betterData).sort((a,b)=> new Date(a.date) > new Date(b.date))));
    })();
    setLoading(false);
  }
